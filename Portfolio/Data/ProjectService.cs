	...
	public class ProjectService
	{
        ...
        public ProjectService()
        {
			_projects = new List<Project>()
			{
				...
				new Project() {ProjectId = 6, Name = "Pet Professionals", Author = $"{myname}", Description = "A responsive website UI design for a pet consulting company.", Url = "", Complete = new DateOnly(2021, 11, 08)},
